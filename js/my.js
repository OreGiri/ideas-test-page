...
for (var i = 0; i < aboutItem.length; i++) {
	aboutItem[i].onmouseenter = function (e) {
		...
		var icon = event.target.closest('.carousel-section-item').querySelector('.icon-about')
	...
	aboutItem[i].onmouseleave = function (e) {
...
for (var i = 0; i < workPortfolioContentItems.length; i++) (function(i){
	...
	workPortfolioContentItems[i].onclick = function() {
		var imgSrc = workPortfolioContentItems[i].querySelector(".work-portfolio-content-item-img").style.backgroundImage.slice(4,-1)
